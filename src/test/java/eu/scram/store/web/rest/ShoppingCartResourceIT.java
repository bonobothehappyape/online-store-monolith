...
import static eu.scram.store.web.rest.TestUtil.sameNumber;
...
import eu.scram.store.domain.ShoppingCart;
import eu.scram.store.domain.enumeration.OrderStatus;
import eu.scram.store.domain.enumeration.PaymentMethod;
import eu.scram.store.repository.ShoppingCartRepository;
