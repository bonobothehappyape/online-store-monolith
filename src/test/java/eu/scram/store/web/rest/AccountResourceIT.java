package eu.scram.store.web.rest;

import static eu.scram.store.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import eu.scram.store.IntegrationTest;
import eu.scram.store.config.Constants;
import eu.scram.store.domain.User;
import eu.scram.store.repository.AuthorityRepository;
import eu.scram.store.repository.UserRepository;
import eu.scram.store.security.AuthoritiesConstants;
import eu.scram.store.service.UserService;
import eu.scram.store.service.dto.AdminUserDTO;
import eu.scram.store.service.dto.PasswordChangeDTO;
import eu.scram.store.service.dto.UserDTO;
import eu.scram.store.web.rest.vm.KeyAndPasswordVM;
import eu.scram.store.web.rest.vm.ManagedUserVM;
