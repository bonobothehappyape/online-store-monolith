...
import eu.scram.store.domain.ProductCategory;
import eu.scram.store.repository.ProductCategoryRepository;
import eu.scram.store.service.ProductCategoryService;
...
/**
 * REST controller for managing {@link eu.scram.store.domain.ProductCategory}.
 */
@RestController
@RequestMapping("/api")
