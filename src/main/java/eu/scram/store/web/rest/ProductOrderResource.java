...
import eu.scram.store.repository.ProductOrderRepository;
import eu.scram.store.service.ProductOrderService;
...
/**
 * REST controller for managing {@link eu.scram.store.domain.ProductOrder}.
 */
@RestController
@RequestMapping("/api")
