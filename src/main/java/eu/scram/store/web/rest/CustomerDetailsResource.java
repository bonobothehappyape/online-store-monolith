...
import eu.scram.store.repository.CustomerDetailsRepository;
import eu.scram.store.service.CustomerDetailsService;
...
/**
 * REST controller for managing {@link eu.scram.store.domain.CustomerDetails}.
 */
@RestController
@RequestMapping("/api")
